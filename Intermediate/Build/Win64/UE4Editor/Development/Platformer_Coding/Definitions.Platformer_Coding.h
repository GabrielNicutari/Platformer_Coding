...
#define ORIGINAL_FILE_NAME "UE4Editor-Platformer_Coding.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Platformer_Coding
#define DEPRECATED_FORGAME DEPRECATED
#define PLATFORMER_CODING_API DLLEXPORT
